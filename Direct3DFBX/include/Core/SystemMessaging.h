...
namespace detail
{
	...
	inline void RecUseParams(int index, const Message & msg, std::tuple<T, Rest...> *, Args*... args)
	{
	...
	inline void RecUseParams(int index, const Message & msg, std::tuple<T> *, Args*... args)
	{
